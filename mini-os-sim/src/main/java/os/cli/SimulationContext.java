...
import os.scheduler.LiveSchedulerController;
...
public class SimulationContext {
    ...
    private final LiveSchedulerController liveSchedulerController;
    ...
    public SimulationContext() {
        ...
        this.ipcManager     = new IPCManager(processManager);
        this.liveSchedulerController = new LiveSchedulerController(processManager);
    ...
    public IPCManager        getIpcManager()    { return ipcManager; }
    public LiveSchedulerController getLiveSchedulerController() { return liveSchedulerController; }
